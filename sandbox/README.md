...
<!--autoload_cluster=.-->
- [ ] `@user_001 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [a as todas tarefas cadastradas](user_001/README.md)
- [ ] `@user_002 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [a as todas tarefas cadastradas](user_002/README.md)
- [ ] `@user_003 🛠️ 👤 type=make xp=1 tier=1 loss=part :self` [Estudo de casa](user_003/README.md)
